...
export const dummyTestimonial = [
  {
    ...
    rating: 5,
    feedback:
      "I’ve been using StudyZone for the past year, mainly to sharpen my cloud skills, and it has been straightforward to follow, making learning so much smoother.",
  },
  {
    name: "Richard Nelson",
    role: "SWE 2 @ Samsung",
    ...
    rating: 4,
    feedback:
      "StudyZone has been part of my routine for over a year now, especially for coding practice, and it is incredibly simple to use, making progress feel effortless.",
  },
  {
    ...
    rating: 4.5,
    feedback:
      "I’ve relied on StudyZone for nearly two years, mostly to stay updated in tech, and it has been very effective and engaging, making continuous learning enjoyable.",
  },
];
